export default {
  ...
  home: {
    ...
    section2: {
      ...
      subtitle: `Izbor za kloniranje ljubimca osobna je i često emocionalno motivirana odluka. Odražava želju za održavanjem fizičke veze izvan životnog vijeka ljubimca, uz poštovanje prema napretku znanosti koji to omogućuje. 
    ...
    section4: {
      text: `Iako je postupak znanstveno složen, cilj je jednostavan: pružiti vlasnicima kućnih ljubimaca priliku da produlje vezu koju imaju sa svojim ljubimcima. 
