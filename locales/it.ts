export default {
  ...
  cookies: {
    ...
    message:
      "Utilizziamo alcuni pacchetti di analisi standard per comprendere il comportamento generale degli utenti, così da capire come migliorare il nostro contenuto. Ciò comporta l'uso di alcuni cookie. Sei d'accordo?",
    accept: 'Accetta',
    decline: 'Rifiuta',
  },
  seo: {
    ...
    aboutUs: {
      title: 'Clonazione di Animali Domestici - Chi siamo',
    },
  },
  validations: {
    ...
    unsavedChanges:
      'Non hai salvato le tue modifiche. Sei sicuro di voler lasciare la pagina?',
  },
  navigation: {
    home: 'Home',
    science: 'Scienza',
  ...
  home: {
    ...
    section1: {
      ...
      subtitle: `In sostanza, la clonazione degli animali domestici è la creazione di un nuovo animale con lo stesso patrimonio genetico dell'originale. È reale, accessibile e realizzato con attenzione alla salute e ai dettagli.
          ...
          I costi della clonazione degli animali domestici da parte di aziende in tutto il mondo riflettono il processo sofisticato:`,
      subtitle_1: `Su questa piattaforma, forniamo approfondimenti sulla clonazione degli animali domestici e sulla conservazione delle cellule, da come funziona a cosa comporta dal punto di vista finanziario ed emotivo.         
          
          Se sei curioso o stai seriamente pensando di clonare il tuo animale domestico, qui troverai una guida diretta e informativa sui passaggi e le decisioni necessari per rendere la clonazione una realtà.`,
      prices: {
        dog: '€50.000 per i cani',
        cat: '€50.000 per i gatti',
        horse: '€85.000 per i cavalli',
      },
    },
    section2: {
    ...
    section3: {
      ...
      step3: {
        ...
        subtitle:
          'Le cellule vengono quindi congelate in azoto liquido per la conservazione delle cellule o per essere inviate a un laboratorio di clonazione. Possono rimanere congelate indefinitamente senza danni.',
      },
      step4: {
      ...
      step5: {
        ...
        subtitle:
          "Una volta trasferito il materiale genetico, l'uovo inizia a svilupparsi in un embrione in un ambiente di laboratorio controllato, simulando lo sviluppo naturale.",
      },
      step6: {
        title: 'Surrogato e Nascita',
        subtitle:
          "L'embrione viene quindi impiantato in una madre surrogata, dove crescerà fino alla nascita. Questo passaggio è cruciale e viene eseguito con attenta monitorazione per garantire la salute e la sicurezza sia della madre surrogata che del clone in sviluppo.",
      },
      step7: {
        title: 'Portare a Casa il Tuo Clone',
        subtitle:
          'Dopo che il clone è nato e svezzato, vengono organizzati i preparativi per far sì che il nuovo animale domestico venga trasportato a casa tua.',
      },
    },
    section4: {
  ...
  science: {
    section1: {
      ...
      step4: {
        ...
        subtitle:
          "L'uovo ricostruito, con il nuovo nucleo, viene stimolato con una corrente elettrica o sostanze chimiche, che lo incoraggiano a dividere e diventare un embrione, proprio come accadrebbe se la fecondazione avvenisse naturalmente.",
      },
      step5: {
        title: "Sviluppo dell'embrione",
        subtitle:
          "Questo embrione viene quindi lasciato sviluppare fino a diventare un blastocisto, una fase iniziale di sviluppo adatta all'impianto in una madre surrogata. In questa fase, il processo di clonazione è lo stesso del processo di fecondazione in vitro.",
      },
      step6: {
    ...
    section2: {
      ...
      step1: {
        ...
        Nel 2000 è nato CC ("CopyCat"), il primo gatto domestico clonato, segnando un momento cruciale per i proprietari di animali domestici in tutto il mondo.`,
      },
      step2: {
      ...
      step3: {
        ...
        subtitle:
          'Progressi nel SCNT e miglioramenti nella scienza genetica hanno portato a processi di clonazione più efficienti e riusciti. La messa a punto di questi protocolli ha portato a tassi di successo più elevati e a una riduzione della probabilità di anomalie riscontrate nei primi cloni.',
      },
      step4: {
        title: 'Clonazione Commerciale',
        subtitle:
          'Negli anni 2010, la clonazione commerciale degli animali domestici è diventata accessibile al pubblico, sebbene a un prezzo elevato. Con questo servizio, i proprietari di animali domestici potevano cercare di clonare un amato animale, che fosse per motivi sentimentali, per preservare tratti eccezionali o per scopi competitivi.',
      },
      step5: {
        title: 'Stato Attuale',
        subtitle:
    ...
    section3: {
      title: 'Progressi Futuri della Clonazione degli Animali Domestici',
      subtitle:
        'La frontiera della clonazione degli animali domestici è una che si muove verso un futuro entusiasmante e in gran parte sconosciuto. I progressi futuri dipendono dai progressi scientifici, dalle considerazioni etiche e dalla domanda pubblica.',
      step1: {
        title: 'Progressi in Genetica e Riproduzione',
        subtitle:
          "Si prevede che i progressi futuri continueranno a migliorare l'efficienza e la affidabilità della clonazione. I progressi nella tecnologia di editing genico CRISPR e nella ricerca sulle cellule staminali potrebbero portare a miglioramenti nel modo in cui vengono prodotti i cloni e nei risultati di salute degli animali clonati. Ciò potrebbe rendere il processo più accessibile e ridurre i costi nel tempo, aprendo potenzialmente la porta affinché più proprietari di animali domestici considerino la clonazione come un'opzione fattibile.",
      },
      step2: {
        title: 'Potenziamento della Conservazione Genetica',
        subtitle:
          'Man mano che la tecnologia di clonazione matura, gli sforzi di conservazione per le specie minacciate utilizzando tecniche di clonazione diventeranno più sofisticati. Ciò potrebbe includere sforzi per reintrodurre la diversità genetica nelle popolazioni in declino, contribuendo al loro recupero e alla loro sostenibilità.',
      },
      step3: {
      ...
      step4: {
        ...
        subtitle:
          'Il futuro vedrà probabilmente un ambiente normativo più definito man mano che la clonazione diventa più diffusa. Le discussioni etiche che circondano le pratiche di clonazione potrebbero influenzare le regolamentazioni e portare a pratiche globali standardizzate che assicurino il benessere degli animali clonati.',
      },
      step5: {
        title: 'Coinvolgimento Pubblico e Educazione',
        subtitle:
          "L'aumento della conoscenza pubblica sulla clonazione attraverso l'educazione giocherà un ruolo critico nel suo sviluppo. Man mano che la comprensione cresce, crescerà anche la conversazione sulle implicazioni morali e pratiche della clonazione, che plasmeranno la direzione del settore.",
      },
      step6: {
        title: "Clonazione per la Ricerca sull'Invecchiamento e le Malattie",
        subtitle:
          "La clonazione può servire come uno strumento di ricerca significativo per lo studio dell'invecchiamento e delle malattie croniche. Producento animali geneticamente identici, gli scienziati possono investigare più accuratamente la progressione delle malattie e l'efficacia dei trattamenti, il che può avere implicazioni profonde sia per la medicina umana che veterinaria.",
      },
    },
  },
  petCloningGuide: {
    ...
    section2: {
      ...
      point2: {
        ...
        subtitle:
          'Un veterinario può garantire che il campione venga prelevato correttamente e conservato in una soluzione fisiologica sterile, reperibile nella maggior parte delle farmacie.',
      },
      point3: {
        title: 'La Raccolta Sterile è Critica',
        subtitle:
          'Quando si raccoglie un campione di pelle, mantenere la sterilità è tanto essenziale quanto la tempestività. I campioni contaminati potrebbero non essere idonei per la clonazione. Se non riesci a trovare un veterinario per effettuare la raccolta, utilizza strumenti e guanti sterilizzati con etanolo.',
      },
    },
    section3: {
    ...
    section4: {
      title: 'Invio del Tuo Campione',
      point1: {
        title: 'Guida Professionale',
        subtitle: 'Prima del prelievo,',
        subtitle_1: 'per informazioni sulle condizioni di spedizione.',
      },
      point2: {
        title: 'Spedizione Sicura e Refrigerata',
        subtitle:
          'Utilizza un contenitore refrigerato per il trasporto e assicurati che rimanga sigillato e alla temperatura stabile e fresca richiesta.',
      },
    },
    section5: {
      text: `Aderendo a queste procedure, aumenti significativamente la probabilità di un
      clone riuscito.

      Le misure proattive per la clonazione di animali vivi generano generalmente un tasso di successo più elevato
      grazie alle condizioni ottimali delle cellule e all'ambiente controllato durante
      la raccolta.

      Ricorda, la qualità del campione e la cura presa durante questi passaggi iniziali sono fondamentali per il percorso
      di creazione di una continuazione genetica del tuo amato animale domestico.`,
    },
  },
  qA: {
...
Petcloning.eu`,
  ...
  aboutUs: {
    ourValues: {
      ...
      text: `Abbiamo creato petcloning.eu per permettere alle persone in Europa di avere accesso alla tecnologia di clonazione per i loro amati animali domestici. Fino ad ora, la clonazione era disponibile in Asia e in America ma era molto difficile da raggiungere per le persone europee. Vogliamo fornire una soluzione sicura, trasparente ed etica per i clienti che desiderano clonare i loro cani, gatti o cavalli. 
      Vogliamo anche fare parte di una tecnologia di clonazione migliore, più efficiente e rispettosa degli animali e stiamo dedicando la nostra esperienza per cercare di aumentare l'efficienza della clonazione.`,
    },
    whoWeAre: {
      title: 'Chi siamo',
      text: "L'attività di Petcloning.eu è iniziata nel 2022 a Split, Croazia. Abbiamo ora anche un laboratorio a Zagabria dove viene svolta la maggior parte della coltura cellulare, mentre il laboratorio a Split è dedicato alla ricerca. Stiamo lavorando insieme alle strutture di clonazione più esperte al mondo che hanno già clonato migliaia di animali domestici provenienti da tutto il mondo.",
      francois: {
        name: 'Francois-Xavier Pellay, PhD',
        title: 'Co-Fondatore e CSO',
        description: `Il Dr. Pellay è un scienziato e imprenditore francese con oltre 15 anni di esperienza nell'industria della longevità e una passione per la scienza e l'invecchiamento. 
        
        Ha co-fondato Petcloning.eu per connettere la sua esperienza nella biologia dell'invecchiamento e la necessità di soluzioni migliorate nella tecnologia di clonazione. Il suo interesse per il settore è anche legato al fatto che la clonazione è in qualche modo la soluzione di ringiovanimento più efficiente mai trovata per ringiovanire le vecchie cellule fino a creare animali giovani e sani.`,
      },
      ronny: {
        name: 'Ronny Haesen',
        title: 'Co-Fondatore e COO',
        description: `Il signor Haesen è un imprenditore belga con esperienza in diversi settori, compresa l'industria biotecnologica dal 2017. 
        
        Durante il processo di facilitazione della coltura cellulare per le strutture di clonazione in Asia e negli Stati Uniti, abbiamo appreso molto presto che c'era poca informazione o assistenza a disposizione degli europei interessati a saperne di più sulla clonazione. Questo è stato il motivo principale per cui, insieme al suo partner commerciale di lunga data, il dott. Pellay, ha fondato Petcloning.eu.`,
      },
    },
    inTheNews: {
      title: 'Petcloning.eu nelle notizie',
      article1: {
        date: '22/02/2024',
        country: 'Francia',
